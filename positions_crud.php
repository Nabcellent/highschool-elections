            ...
            while($row = mysqli_fetch_array($result)) {
                ...
                <tr id="<?php echo $row["position_id"]; ?>">
                    ...
                    <td>
                        ...
                        <a href="#deletePositionModal" class="delete" data-id="<?= $row["position_id"] ?>" data-toggle="modal">
            ...
            <form id="positions_form">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="position_name" name="position_name" placeholder="Enter Position's Name *">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="form1" name="eligibility[]" value="1">
                            <label class="form-check-label" for="form1">Form 1</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="form2" name="eligibility[]" value="2">
                            <label class="form-check-label" for="form2">Form 2</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="form3" name="eligibility[]" value="3">
                            <label class="form-check-label" for="form3">Form 3</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="form4" name="eligibility[]" value="4">
        ...
        <div class="modal-content">
            <form id="update_positions_form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="position_name"> NAME :</label>
                        <input class="form-control" type="text" id="position_name_edit" name="position_name" placeholder="Enter Position's Name *">
                    </div>
                    <div class="form-group">
                        <label for="position_level"> LEVEL :</label>
                    ...
                    <div class="form-group mb-0">
                        <label class="frm_labels" for="position_eligibility"> ELIGIBILITY :</label>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="form1_edit" name="eligibility[]" value="1">
                            <label class="form-check-label" for="form1">Form 1</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="form2_edit" name="eligibility[]" value="2">
                            <label class="form-check-label" for="form2">Form 2</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="form3_edit" name="eligibility[]" value="3">
                            <label class="form-check-label" for="form3">Form 3</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="form4_edit" name="eligibility[]" value="4">
                            <label class="form-check-label" for="form4">Form 4</label><br>
                        </div>
