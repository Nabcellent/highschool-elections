...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 10, 2020 at 08:27 PM
...
INSERT INTO `nominators_tbl` (`nominator_id`, `student_id`, `nominee_id`, `nominee_class_id`, `nominator_type`, `position_id`) VALUES
(1, 13, 13, 14, 'proposer', 8),
(2, 13, 7, 15, 'seconder', 2),
(3, 11, 15, 10, 'proposer', 7),
(4, 5, 16, 19, 'proposer', 7),
(5, 30, 117, 13, 'seconder', 3),
(6, 53, 123, 16, 'proposer', 5),
(7, 117, 103, 17, 'proposer', 6),
(8, 6, 122, 16, 'seconder', 8),
(12, 6, 107, 15, 'proposer', 2),
(13, 66, 64, 3, 'proposer', 8),
(14, 23, 65, 3, 'seconder', 7),
(15, 23, 34, 2, 'proposer', 8),
(16, 126, 53, 14, 'seconder', 4),
(17, 123, 53, 14, 'seconder', 4),
(18, 122, 53, 14, 'proposer', 4),
(19, 114, 53, 14, 'proposer', 4),
(20, 124, 53, 14, 'seconder', 4),
(21, 119, 117, 13, 'seconder', 3),
(22, 125, 117, 13, 'proposer', 3),
(23, 121, 117, 13, 'proposer', 3),
(25, 118, 117, 13, 'seconder', 3),
(26, 112, 117, 13, 'seconder', 3),
(27, 35, 34, 2, 'seconder', 8),
(28, 2, 34, 2, 'seconder', 8),
(29, 29, 122, 16, 'proposer', 8),
(30, 29, 117, 13, 'seconder', 3),
(31, 63, 23, 2, 'proposer', 7),
(32, 3, 67, 11, 'proposer', 7),
(33, 4, 46, 17, 'proposer', 2),
(34, 4, 30, 14, 'proposer', 3),
(35, 4, 123, 16, 'proposer', 5),
(36, 4, 53, 14, 'seconder', 4),
(37, 4, 51, 14, 'proposer', 7),
(38, 43, 46, 17, 'proposer', 2),
(39, 43, 30, 14, 'seconder', 3),
(40, 43, 123, 16, 'seconder', 5),
(41, 43, 53, 14, 'seconder', 4),
(42, 43, 51, 14, 'proposer', 7),
(43, 44, 46, 17, 'seconder', 2),
(44, 44, 30, 14, 'proposer', 3),
(45, 44, 123, 16, 'seconder', 5),
(46, 44, 51, 14, 'seconder', 7),
(47, 45, 46, 17, 'seconder', 2),
(48, 45, 30, 14, 'seconder', 3),
(49, 45, 123, 16, 'seconder', 5),
(50, 45, 51, 14, 'seconder', 7),
(51, 46, 46, 17, 'seconder', 2),
(52, 46, 30, 14, 'seconder', 3),
(53, 46, 123, 16, 'seconder', 5),
(54, 46, 51, 14, 'seconder', 7),
(55, 102, 46, 17, 'seconder', 2),
(56, 102, 30, 14, 'seconder', 3),
(57, 102, 123, 16, 'seconder', 5),
(58, 102, 51, 14, 'seconder', 7),
(59, 103, 46, 17, 'seconder', 2),
(60, 103, 30, 14, 'seconder', 3),
(61, 103, 51, 14, 'seconder', 7),
(62, 2, 23, 2, 'proposer', 7),
(63, 68, 67, 11, 'seconder', 7);
...
INSERT INTO `vote_tbl` (`vote_id`, `voter_id`, `head_boy_id`, `head_girl_id`, `dh_capt_id`, `games_capt_id`, `lib_capt_id`, `form_capt_id`, `class_prefect_id`) VALUES
(6, 63, 107, 117, 123, 53, 103, 65, 64),
(7, 23, 46, 30, 123, 53, 103, 65, 34),
(8, 34, 46, 117, 123, 53, 103, 23, 34),
(9, 35, 46, 30, 123, 53, 103, 65, 34),
(10, 127, 46, 30, 123, 53, 103, 23, 34),
(11, 30, 46, 30, 123, 53, 103, 51, 13);
...
--
-- Indexes for table `nominators_tbl`
--
ALTER TABLE `nominators_tbl`
  ADD PRIMARY KEY (`nominator_id`),
  ADD KEY `student_id` (`student_id`),
  ADD KEY `nominee_id` (`nominee_id`),
  ADD KEY `nominee_class` (`nominee_class_id`),
...
ALTER TABLE `vote_tbl`
  ...
  ADD KEY `head_boy` (`head_boy_id`),
  ADD KEY `head_girl` (`head_girl_id`),
  ADD KEY `dh_capt` (`dh_capt_id`),
  ADD KEY `games_capt` (`games_capt_id`),
  ADD KEY `lib_capt` (`lib_capt_id`),
  ADD KEY `form_capt` (`form_capt_id`),
  ADD KEY `class_prefect` (`class_prefect_id`),
...
--
-- AUTO_INCREMENT for table `nominators_tbl`
--
ALTER TABLE `nominators_tbl`
  MODIFY `nominator_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
...
--
-- Constraints for table `nominators_tbl`
--
ALTER TABLE `nominators_tbl`
  ADD CONSTRAINT `nominators_tbl_ibfk_1` FOREIGN KEY (`nominee_class_id`) REFERENCES `classes_tbl` (`class_id`),
  ADD CONSTRAINT `nominators_tbl_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `users_tbl` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `nominators_tbl_ibfk_3` FOREIGN KEY (`nominee_id`) REFERENCES `users_tbl` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `nominators_tbl_ibfk_4` FOREIGN KEY (`position_id`) REFERENCES `positions_tbl` (`position_id`) ON UPDATE CASCADE;
...
--
ALTER TABLE `vote_tbl`
  ADD CONSTRAINT `vote_tbl_ibfk_1` FOREIGN KEY (`voter_id`) REFERENCES `users_tbl` (`user_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `vote_tbl_ibfk_2` FOREIGN KEY (`head_boy_id`) REFERENCES `users_tbl` (`user_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `vote_tbl_ibfk_3` FOREIGN KEY (`head_girl_id`) REFERENCES `users_tbl` (`user_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `vote_tbl_ibfk_4` FOREIGN KEY (`dh_capt_id`) REFERENCES `users_tbl` (`user_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `vote_tbl_ibfk_5` FOREIGN KEY (`games_capt_id`) REFERENCES `users_tbl` (`user_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `vote_tbl_ibfk_6` FOREIGN KEY (`lib_capt_id`) REFERENCES `users_tbl` (`user_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `vote_tbl_ibfk_7` FOREIGN KEY (`form_capt_id`) REFERENCES `users_tbl` (`user_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `vote_tbl_ibfk_8` FOREIGN KEY (`class_prefect_id`) REFERENCES `users_tbl` (`user_id`) ON UPDATE CASCADE;
COMMIT;
