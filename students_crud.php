            ...
            <table class="table table-striped table-hover" id="students_table">
                ...
                while ($student = mysqli_fetch_array($query)) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="fa-edit" href="#editStudentModal" data-toggle="modal">
                                <i class="material-icons update-student" data-toggle="tooltip"
                            ...
                            <a class="delete" href="#deleteStudentModal" data-toggle="modal" data-id="<?= $student['user_id'] ?>">
                                <i class="material-icons delete" data-toggle="tooltip" title="Delete">delete</i>
                            </a>
                        </td>
                    </tr>
                ...
                <form id="students_form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="last_name" name="last_name" placeholder="Enter Second Name *">
                        </div>
                        <div class="form-group">
                ...
                <form id="update_students_form">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <label for="first_name">FIRST NAME :</label>
                            <input class="form-control" type="text" id="first_name_edit" name="first_name" placeholder="Enter First Name *">
                        </div>
                        <div class="form-group">
                            <label for="last_name">SURNAME :</label>
                            <input class="form-control" type="text" id="last_name_edit" name="last_name" placeholder="Enter Second Name *">
                        </div>
                        <div class="form-group">
                            <label for="students_class"> CLASS :</label>
